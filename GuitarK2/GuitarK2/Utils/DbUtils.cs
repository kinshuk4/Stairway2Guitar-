...
namespace GuitarK2.Utils
{
    class DbUtils
    {
        
        public static string FixedPath = "D:/lyf/programs/wpf/GuitarK2/GuitarK2/db/GuitarDB.accdb";
        public static string relativePath = "../../Resources/db/GuitarDB.accdb";
        public static string provider = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=";

        public static string conConnectionString = provider + relativePath;
