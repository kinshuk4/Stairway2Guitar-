...
namespace GuitarK2.Tools.MidiBand
{
    /// <summary>
    /// Interaction logic for MidiBandWindow.xaml
    /// </summary>
    public partial class MidiBandWindow : Window
    {
        #region atrributes
        ...
        {
            Nullable<bool> result = openMidiFileDialog.ShowDialog();
